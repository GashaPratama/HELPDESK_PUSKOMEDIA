...
<head>
    ...
    <title>Puskomedia Helpdesk - Edit Nama</title>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="hidden sm:block">
                            <h1 class="text-lg font-semibold text-slate-800">Edit Nama</h1>
                        </div>
                    </div>
                </div>
        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-2xl card-shadow p-8">
                <div class="text-center mb-8">
                    ...
                    <h2 class="text-2xl font-bold text-slate-800 mb-2">Edit Nama Lengkap</h2>
                    <p class="text-slate-600">Ubah nama lengkap Anda</p>
                </div>
                ...
                <!-- Edit Form -->
                <form method="POST" action="{{ route('customer.update-nama') }}" class="space-y-6">
                    @csrf
