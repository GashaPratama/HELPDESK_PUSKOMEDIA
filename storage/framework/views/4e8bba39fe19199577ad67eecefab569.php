<?php $__env->startSection('title', 'Kelola Tiket - Customer Service'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-4">
          <!-- Arsip Tiket Button -->
          <a href="<?php echo e(route('cs.archive.index')); ?>" 
      ...
      <div class="bg-white rounded-lg shadow hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 p-6">
        <div class="flex items-center">
          ...
          <div>
            ...
            <p class="text-2xl font-bold text-gray-900" data-count="total"><?php echo e($totalLaporan); ?></p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 p-6">
        <div class="flex items-center">
          ...
          <div>
            ...
            <p class="text-2xl font-bold text-gray-900" data-count="diproses"><?php echo e($laporanDiproses); ?></p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 p-6">
        <div class="flex items-center">
          ...
          <div>
            ...
            <p class="text-2xl font-bold text-gray-900" data-count="selesai"><?php echo e($laporanSelesai); ?></p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 p-6">
        <div class="flex items-center">
          ...
          <div>
            ...
            <p class="text-2xl font-bold text-gray-900" data-count="ditolak"><?php echo e($laporanDitolak); ?></p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div>
          ...
          <select id="kategoriFilter" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 hover:border-blue-400 focus:scale-105">
            ...
            <?php $__currentLoopData = \App\Models\Kategori::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="bg-white rounded-lg shadow hover:shadow-lg transition-all duration-300">
      <div class="px-6 py-4 border-b border-gray-200">
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center space-x-4">
            <button class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg font-medium flex items-center gap-2 transition-all duration-200 hover:scale-105 hover:shadow-lg">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <?php $__currentLoopData = $laporans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $laporan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="hover:bg-gray-50 transition-colors duration-200">
                  <td class="px-6 py-4 whitespace-nowrap">
                    <input type="checkbox" name="selected_tickets[]" value="<?php echo e($laporan->id); ?>" class="ticket-checkbox rounded border-gray-300 text-blue-600 focus:ring-blue-500 hover:scale-110 transition-transform duration-200" onchange="updateSelectAllCheckbox()">
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                    #<?php echo e($laporan->ticket_id ?? $laporan->id); ?>
                    ...
                    <div class="flex items-center">
                      <div class="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center mr-3 hover:scale-110 transition-transform duration-200">
                        <span class="text-xs font-medium text-gray-600">
                          <?php echo e(substr($laporan->customer->nama_lengkap ?? 'N/A', 0, 1)); ?>

                        </span>
                      </div>
                      <div>
                        <div class="font-medium"><?php echo e($laporan->customer->nama_lengkap ?? 'N/A'); ?></div>
                        <div class="text-xs text-gray-500"><?php echo e($laporan->customer->email ?? 'N/A'); ?></div>
                      </div>
                    </div>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap" data-kategori-id="<?php echo e($laporan->kategori->id ?? ''); ?>">
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 hover:bg-blue-200 transition-colors duration-200">
                      <?php echo e($laporan->kategori->nama ?? 'Tidak ada kategori'); ?>

                    </span>
                        </td>
                  <td class="px-6 py-4 text-sm text-gray-900">
                    <div class="max-w-xs break-all">
                      <?php echo e($laporan->kendala); ?>
                    ...
                    <?php if($laporan->foto): ?>
                      <div class="flex items-center">
                        <img src="<?php echo e(asset('storage/' . $laporan->foto)); ?>" 
                             ...
                             onclick="openPhotoModal('<?php echo e(asset('storage/' . $laporan->foto)); ?>')">
                      </div>
                    <?php else: ?>
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    ?>
                  <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($colorClass); ?> hover:scale-105 transition-transform duration-200">
                    <?php echo e($status); ?>

                  </span>
                        </td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    <?php echo e($laporan->created_at->format('d M Y H:i')); ?>

                        </td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <div class="flex items-center space-x-2">
                      <!-- Dropdown Status -->
                      <form action="<?php echo e(route('cs.laporan.update', $laporan->id)); ?>" method="POST" class="inline">
                                <?php echo csrf_field(); ?>
                        <input type="hidden" name="notes" value="<?php echo e($laporan->notes ?? ''); ?>">
                        <input type="hidden" name="assigned_to" value="<?php echo e($laporan->assigned_to ?? ''); ?>">
                      ...
                      <button
                        ...
                        data-fallback-modal="true"
                        data-ticket-id="<?php echo e($laporan->ticket_id ?? $laporan->id); ?>"
                        data-customer="<?php echo e($laporan->customer->nama_lengkap ?? 'N/A'); ?>"
                        data-kategori="<?php echo e($laporan->kategori->nama ?? '-'); ?>"
                        data-status="<?php echo e($laporan->status ?? '-'); ?>"
                        data-deskripsi="<?php echo e($laporan->kendala ?? '-'); ?>"
                        data-created-at="<?php echo e($laporan->created_at ? $laporan->created_at->format('d M Y H:i') : '-'); ?>"
                        @click="openTicketDetail('<?php echo e($laporan->ticket_id ?? $laporan->id); ?>', '<?php echo e($laporan->kategori->nama ?? '-'); ?>', <?php echo \Illuminate\Support\Js::from($laporan->kendala ?? '-')->toHtml() ?>, '<?php echo e($laporan->status ?? '-'); ?>', '<?php echo e($laporan->url_situs ?? ''); ?>', '<?php echo e($laporan->customer->nama_lengkap ?? 'N/A'); ?>', '<?php echo e($laporan->created_at ? $laporan->created_at->format('d M Y H:i') : '-'); ?>')"
                      >
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <!-- Button Note -->
                      <button onclick="openNoteModal('<?php echo e($laporan->ticket_id ?? $laporan->id); ?>', '<?php echo e($laporan->note ?? ''); ?>', '<?php echo e($laporan->note_target_role ?? ''); ?>')" 
                      ...
                      <!-- Button Assign -->
                      <button onclick="openAssignModal('<?php echo e($laporan->ticket_id ?? $laporan->id); ?>', '<?php echo e($laporan->assigned_to ?? ''); ?>')" 
...
function deleteSelectedTickets() {
  ...
  Swal.fire({
    ...
    form.method = 'POST';
    form.action = '<?php echo e(route("tickets.bulk-delete")); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Tugas\HELPDESK_PUSKOMEDIA\resources\views/customerservice/dashboard.blade.php ENDPATH**/ ?>