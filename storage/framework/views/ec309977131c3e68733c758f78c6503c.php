<?php $__env->startSection('title', 'Management Tiket - Teknisi'); ?>
  ...
  <div class="bg-white border-b border-gray-200 shadow-sm">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-4">
          <!-- Arsip Tiket Button -->
          <a href="<?php echo e(route('teknisi.archive.index')); ?>" 
          ...
          <div class="flex items-center space-x-3">
            <div class="text-right">
              <p class="text-sm font-medium text-gray-900"><?php echo e(auth()->user()->nama_lengkap ?? auth()->user()->name); ?></p>
      ...
      <div class="bg-white rounded-lg shadow hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 p-6">
        <div class="flex items-center">
          ...
          <div>
            ...
            <p class="text-2xl font-bold text-gray-900" data-count="total"><?php echo e($stats['total']); ?></p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 p-6">
        <div class="flex items-center">
          ...
          <div>
            ...
            <p class="text-2xl font-bold text-gray-900" data-count="diproses"><?php echo e($stats['diproses']); ?></p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 p-6">
        <div class="flex items-center">
          ...
          <div>
            ...
            <p class="text-2xl font-bold text-gray-900" data-count="selesai"><?php echo e($stats['selesai']); ?></p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 p-6">
        <div class="flex items-center">
          ...
          <div>
            ...
            <p class="text-2xl font-bold text-gray-900" data-count="ditolak"><?php echo e($stats['ditolak']); ?></p>
          </div>
        </div>
      </div>
    </div>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <tr class="hover:bg-gray-50 transition-colors duration-200">
                <td class="px-6 py-4 whitespace-nowrap">
                  <input type="checkbox" name="selected_tickets[]" value="<?php echo e($ticket->id); ?>" 
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-mono text-gray-900">
                  #<?php echo e($ticket->ticket_id ?? $ticket->id); ?>

                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    <?php if($ticket->customer->foto_profil): ?>
                      <img src="<?php echo e(asset('storage/' . $ticket->customer->foto_profil)); ?>" 
                           alt="Customer Avatar" 
                      ...
                      <div class="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-sm hover:scale-110 transition-transform duration-200">
                        <?php echo e(substr($ticket->customer->nama_lengkap ?? 'N', 0, 1)); ?>

                      </div>
                            <?php endif; ?>
                    <div class="ml-3">
                      <div class="text-sm font-medium text-gray-900"><?php echo e($ticket->customer->nama_lengkap ?? 'N/A'); ?></div>
                      <div class="text-sm text-gray-500"><?php echo e($ticket->customer->email ?? 'N/A'); ?></div>
                    </div>
                  </div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                  <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 hover:bg-blue-200 transition-colors duration-200">
                    <?php echo e($ticket->kategori->nama ?? 'Tidak ada kategori'); ?>

                  </span>
                </td>
                <td class="px-6 py-4 text-sm text-gray-900">
                  <div class="max-w-xs break-all">
                    <?php echo e($ticket->kendala); ?>
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <?php if($ticket->foto): ?>
                    <div class="flex items-center">
                      <img src="<?php echo e(asset('storage/' . $ticket->foto)); ?>" 
                           alt="Foto Bukti" 
                           ...
                           onclick="openPhotoModal('<?php echo e(asset('storage/' . $ticket->foto)); ?>')">
                    </div>
                  <?php else: ?>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  <div class="flex items-center space-x-2">
                    ...
                    <form action="<?php echo e(route('teknisi.tickets.updateStatus', $ticket->id)); ?>" method="POST" class="inline">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                      <input type="hidden" name="notes" value="<?php echo e($ticket->notes ?? ''); ?>">
                      <select name="status" onchange="this.form.submit()" 
                              class="text-xs border-gray-300 rounded px-2 py-1 focus:ring-blue-500 focus:border-blue-500">
                        <option value="Diproses" <?php echo e($ticket->status == 'Diproses' ? 'selected' : ''); ?>>Diproses</option>
                        <option value="Selesai" <?php echo e($ticket->status == 'Selesai' ? 'selected' : ''); ?>>Selesai</option>
                        <option value="Ditolak" <?php echo e($ticket->status == 'Ditolak' ? 'selected' : ''); ?>>Ditolak</option>
                                </select>
                            </form>
                    
                    <!-- Detail Button -->
                    <button onclick="openTicketDetail('<?php echo e($ticket->ticket_id ?? $ticket->id); ?>', '<?php echo e($ticket->kategori->nama ?? '-'); ?>', <?php echo \Illuminate\Support\Js::from($ticket->kendala ?? '-')->toHtml() ?>, '<?php echo e($ticket->status ?? '-'); ?>', '<?php echo e($ticket->url_situs ?? ''); ?>', '<?php echo e($ticket->customer->nama_lengkap ?? 'N/A'); ?>', '<?php echo e($ticket->created_at ? $ticket->created_at->format('d M Y H:i') : '-'); ?>')"
                    ...
                    <button onclick="openStatusModal('<?php echo e($ticket->ticket_id ?? $ticket->id); ?>', '<?php echo e($ticket->status ?? ''); ?>')" 
                    ...
                    <!-- Note Button -->
                    <button onclick="openNoteModal('<?php echo e($ticket->ticket_id ?? $ticket->id); ?>', '<?php echo e($ticket->note ?? ''); ?>', '<?php echo e($ticket->note_target_role ?? ''); ?>')" 
                    ...
                    <!-- Remove Button -->
                    <button onclick="confirmRemoveTicket('<?php echo e($ticket->id); ?>', '<?php echo e($ticket->ticket_id ?? $ticket->id); ?>')"
...
function executeBulkAction() {
  ...
  if (action === 'update_status') {
    ...
    if (newStatus && ['Diproses', 'Selesai', 'Ditolak'].includes(newStatus)) {
      ...
      form.method = 'POST';
      form.action = '<?php echo e(route("teknisi.tickets.bulk")); ?>';
...
function deleteSelectedTickets() {
  ...
  Swal.fire({
    ...
    const form = document.createElement('form');
    form.method = 'POST';
    form.action = '<?php echo e(route("teknisi.tickets.bulk-delete")); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Tugas\HELPDESK_PUSKOMEDIA\resources\views/teknisi/dashboard.blade.php ENDPATH**/ ?>